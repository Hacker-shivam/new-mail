...
const BULK_EMAIL_BATCH_SIZE = numberEnv("BULK_EMAIL_BATCH_SIZE", 400);
const BULK_EMAIL_BATCH_DELAY_MS = numberEnv("BULK_EMAIL_BATCH_DELAY_MS", 1000);
const BULK_EMAIL_WORKER_INTERVAL_MS = numberEnv("BULK_EMAIL_WORKER_INTERVAL_MS", 1000);
const STALE_LOCK_MS = numberEnv("BULK_EMAIL_STALE_LOCK_MS", 5 * 60 * 1000);
const BULK_EMAIL_SEND_CONCURRENCY = numberEnv("BULK_EMAIL_SEND_CONCURRENCY", 100);
...
const BULK_EMAIL_POLL_LIMIT = numberEnv("BULK_EMAIL_POLL_LIMIT", 10);
